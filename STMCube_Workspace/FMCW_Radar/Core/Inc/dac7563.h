...
#ifndef INC_DAC7563_H_
#define INC_DAC7563_H_
...
#define DAC_NCLR_PORT	GPIOB
#define DAC_NCLR_PIN	GPIO_PIN_2
#define NSS_DAC7563_GPIO_PORT GPIOB
#define NSS_DAC7563_PIN GPIO_PIN_12
